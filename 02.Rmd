...
Incarnations of this idea include the Amazon Echo, Google Home, and the Apply HomePod.
...
Given the enough data, perhaps your mother's Facebook page, it might be able to recommend a good Christmas gift for her.
...
Since hours of high-resolution video data are required for training, prominent Movie or TV stars would be ideal targets as there are many hours of video footage of them to train on.
...
Apart from Morgan Freeman, which types of aactors should be shown?
...
Perhaps an infrared face scanner, similar to the technology slated for the iPhone X, could be used to gauge the users' reactions from facial expressions (which may differ from what they **say**).
